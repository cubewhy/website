...
<head>
    ...
    <link id="favicon" rel="icon"
          href="https://cdn.jsdelivr.net/gh/CubeWhyMC/celestial/src/main/resources/images/icons/icon-light.png"
          type="image/png">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarExample01">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/help" target="_blank" data-i18n="nav-doc">Docs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/plugins" data-i18n="nav-plugins">Plugins</a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav d-flex flex-row">
                    ...
                    <li class="nav-item me-3 me-lg-0">
                        <a class="nav-link" href="https://github.com/CubeWhyMC/celestial" rel="nofollow"
                           target="_blank">
                            <!--                <i class="fab fa-github"></i>-->
                            <img class="fab" alt="GitHub Repo stars"
                                 src="https://img.shields.io/github/stars/CubeWhyMC/celestial">
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.8);">
            <div class="container d-flex align-items-center justify-content-center text-center h-100">
                <div class="text-white" data-mdb-theme="dark">
                    ...
                    <p><label class="mb-4" data-i18n="launch-count"></label><label id="count">UNKNOWN (WIP)</label></p>
                ...
                <div class="col-lg-4 col-md-12 mb-4">
                    <div class="card">
                        <div class="bg-image hover-overlay" data-mdb-ripple-init data-mdb-ripple-color="light">
                            <img src="/images/attack/attack2.jpg" class="img-fluid"/>
                            <a href="#">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                            </a>
                        </div>
                        <div class="card-body">
                            ...
                            <p class="card-text" data-i18n="case-content1"></p>
                            <a href="#" class="btn btn-primary scrollToTopButton" data-mdb-ripple-init
                               data-i18n="case-download">DOWNLOAD</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://discord.gg/rCqCepgWJc" class="btn btn-primary" data-mdb-ripple-init
                               data-i18n="case-join">DOWNLOAD</a>
                        </div>
                    </div>
                </div>
            </div>
...
<footer class="bg-body-tertiary text-center">
    ...
    <div class="container p-4">
        ...
        <section class="mb-4">
            <!-- Github -->
            <a data-mdb-ripple-init class="btn btn-outline btn-floating m-1" href="https://github.com/CubeWhyMC"
        ...
        <!-- Section: Text -->
        <section class="mb-4">
            <p>抗揍CDN就用<a href="https://cdn.nuee.cn">cdn.nuee.cn</a>, 站长推荐cdn,向日葵打了1t都打不死</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a class="text-body" href="https://github.com/CubeWhyMC/celestial" data-i18n="footer-repo">GitHub
                                Repo</a><br>
